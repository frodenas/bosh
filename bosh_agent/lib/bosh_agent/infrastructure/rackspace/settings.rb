...
module Bosh::Agent
  ##
  # BOSH Agent settings for Infrastructure Rackspace
  #
  class Infrastructure::Rackspace::Settings

    VIP_NETWORK_TYPE        = 'vip'
    DHCP_NETWORK_TYPE       = 'dynamic'
    MANUAL_NETWORK_TYPE     = 'manual'
    SUPPORTED_NETWORK_TYPES = [DHCP_NETWORK_TYPE]
    ...
    def load_settings
      setup_openssh_key
      Infrastructure::Rackspace::Registry.get_settings
    end
    ...
    def setup_openssh_key
      public_key = Infrastructure::Rackspace::Registry.get_openssh_key
